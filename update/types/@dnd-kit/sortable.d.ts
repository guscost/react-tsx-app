...
declare function hasSortableData<
...
declare function SortableContext({
  children,
  id,
...
export {
  ...
  type NewIndexGetter,
  SortableContext,
  type Props as SortableContextProps,
  type SortableData,
  type SortingStrategy,
  type Arguments as UseSortableArguments,
  arrayMove,
  arraySwap,
