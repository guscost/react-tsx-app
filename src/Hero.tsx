...
export default function Hero() {
	...
	return (
		<div>
			...
			<button className="p-2 mt-2 rounded border hover:bg-gray-100" onClick={() => setCount(count + 1)}>Again!</button>

			<Select.Root onValueChange={value => setCount(parseInt(value, 10))}>
				<Select.Trigger className="border rounded mt-2 px-4 py-2 flex gap-2 justify-between items-center w-56" aria-label="Number">
