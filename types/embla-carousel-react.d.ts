...
type OptionsHandlerType = {
    mergeOptions: <TypeA extends OptionsType$1, TypeB extends OptionsType$1>(optionsA: TypeA, optionsB?: TypeB) => TypeA;
...
export { type EmblaViewportRefType, type UseEmblaCarouselType, useEmblaCarousel as default };
